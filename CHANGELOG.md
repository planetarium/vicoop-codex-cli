...
- c2ce275: fix(cache): present the `codex_cli_rs` User-Agent only for gpt-5.6-luna, restoring the cache-safe legacy UA everywhere else
  ...
  production hit _ratio_ fell 78–93% → 30–51% across all models right at the
